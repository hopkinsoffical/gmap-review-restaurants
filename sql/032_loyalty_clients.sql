...
-- the member-tier model's review-booster source: first capture of a phone
...
--
-- Used as a Supabase fallback when a restaurant store slug is not yet registered
-- in vForce (api/loyalty-signup.js). Run in the restaurant Supabase SQL Editor
-- after sql/001_schema.sql. Idempotent.
