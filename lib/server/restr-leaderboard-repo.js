...
const RESTR_READ_SOURCE = "restr_ai_leaderboard_latest";
const SELECT_WITH_DIMS =
  "id, slug, name, address, state, county, town, zipcode, category, rating, review_count, phone, website, sentiment_p, freshness_f, ai_score, dim_reviews_score, dim_rating_score, dim_sentiment_score, dim_recency_score, dim_local_seo_score, dim_conversion_score, assessment_level, place_id, google_place_id, profile_updated_at";
