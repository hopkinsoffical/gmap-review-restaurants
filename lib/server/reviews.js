...
function buildGuaranteedFallbackText(cardPlan, servicePraise, lang) {
  ...
  if (cardPlan.focusKey === "environment") {
    if (cardPlan.styleKey === "review_a") return "The restaurant felt very clean and comfortable. Really happy with the meal.";
    if (cardPlan.styleKey === "review_b") return "The space felt clean, calm, and easy to relax in. Would come back for this.";
    return "What stood out most is that the restaurant felt relaxing and well kept. Better than I expected.";
  }
  if (cardPlan.styleKey === "review_a") return "The flavors were natural and well balanced. Really happy with the meal.";
  if (cardPlan.styleKey === "review_b") return "The dish came out really well and the portion felt right. Would come back for this.";
  return "What I noticed most is that the meal came out fresh and satisfying. Better than I expected.";
}
