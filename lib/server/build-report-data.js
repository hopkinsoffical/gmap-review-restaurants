/**
 * Salon brief report scoring — ported from report_update_files/buildReportData.ts
 */

const DEFAULT_SERVICES = [
  { name: "Hair styling", search_volume: 72, competition: 48 },
  { name: "Color & highlights", search_volume: 65, competition: 55 },
  { name: "Nail services", search_volume: 58, competition: 52 },
  { name: "Spa & wellness", search_volume: 44, competition: 38 },
  { name: "Bridal & events", search_volume: 36, competition: 42 },
];
...
function rawSalonRowFromStore(row, localRank) {
  ...
  return {
    ...
    city: city || "Local",
    state: state,
    category: String(report.category || row.category || "Beauty salon").trim(),
